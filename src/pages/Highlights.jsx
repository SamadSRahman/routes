...
.catch((error)=>console.log(error))
  ...
  return (
    <>
      ...
      <BuilderComponent model="page" data={{organisation:data,highlights:highlights,buttonText:"View More", style : "4rem", selectedImgIndex:selectedImgIndex, selectedHighlightIndex :0 }} content={content} />
